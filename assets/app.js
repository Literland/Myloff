...
// Exponer funciones usadas por atributos onclick del HTML (asegura compatibilidad)
try {
    ...
    // Icon update también puede ser útil desde HTML
    window.updateMusicIcon = updateMusicIcon;
} catch (e) {
    // en caso de que alguna función no exista aún, lo dejamos sin bloquear
    console.warn('No se pudieron exponer todas las funciones globales:', e);
}
